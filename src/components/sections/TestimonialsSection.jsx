...
const TestimonialsSection = ({cardsData}) => {
  ...
  return (
    <section ref={ref} className={`py-20 sm:py-24 bg-[#f9fafb] overflow-hidden ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12"} `}>

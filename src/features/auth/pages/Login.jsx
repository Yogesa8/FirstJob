...
const reviews = [
    {
        ...
        role: "Fresher, Placed Successfully",
        rating: 5
    },
    {
        name: "Sahil",
...
const Login = () => {
    ...
    const handleLogin = (e) => {
        ...
        if (email === "test@gmail.com" && password === "12345") {
            ...
            alert("Invalid credentials. Please use test@gmail.com / 12345");
        }
    }
    ...
    return (
        <div className="min-h-screen bg-white flex flex-col lg:flex-row">
            {/* Left Side - Testimonial + Logo */}
            <div className="hidden lg:flex lg:w-[60%] bg-white flex-col items-center justify-center px-12 relative">
                {/* Logo */}
                <div className="mb-12">
                    <img src={firstJobInd} alt="FirstJob Logo" className="w-40 h-40 object-contain" />
                </div>
            ...
            <div className="w-full lg:w-[40%] flex items-center justify-center p-8 bg-gray-50">
                <div className="w-full max-w-md">
                    ...
                    <div className="lg:hidden text-center mb-10">
                        <img src={firstJobInd} alt="FirstJob Logo" className="w-28 h-28 object-contain mx-auto" />
                    </div>
                    ...
                    <form onSubmit={handleLogin} className="space-y-6">
                        ...
                        <div className="text-right">
                            <Link to="/forgot-password" className="text-orange-500 text-sm font-medium hover:underline">
                                Forgot password?
                            </Link>
                        </div>

                                ...
                                {projects.map((project, index) => (
                                    <div key={index}>
                                        ...
                                        {project.description && project.description !== '<p></p>' && (
                                            <div
                                                className="list-disc list-inside text-sm text-zinc-700  space-y-1 preview-content"
                    ...
                    {(() => {
                        ...
                        return (
                            <section className="mt-6">
                                {languages.length > 0 && (
                                    <div className="mb-3">
                                        <h3 className="text-sm font-semibold tracking-widest mb-2" style={{ color: accentColor }}>Languages</h3>
                                ...
                                {hobbies.length > 0 && (
                                    <div className="mb-3">
                                        <h3 className="text-sm font-semibold tracking-widest mb-2" style={{ color: accentColor }}>Hobbies</h3>
                                        <ul className="list-disc list-inside text-zinc-700">
                                ...
                                {certifications.length > 0 && (
                                    <div className="mb-3">
                                        <h3 className="text-sm font-semibold tracking-widest mb-2" style={{ color: accentColor }}>Certifications</h3>
                                        <ul className="list-disc list-inside text-zinc-700">
                                    ...
                                    <div className="mt-2 space-y-2">
                                        {others.fields.map((f, i) => (
                                            <div key={i}>
                                                ...
                                                <div className="text-zinc-700">{f.value}</div>
                                            </div>
                                        ))}
                                    </div>
                                )}

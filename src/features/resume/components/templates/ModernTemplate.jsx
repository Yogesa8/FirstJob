							...
							{projects.map((p, index) => (
								<div key={index} className="relative pl-6 border-l border-gray-200" style={{ borderLeftColor: accentColor }}>
									...
									{p.description && p.description !== '<p></p>' && (
										<div
											className="text-gray-700 leading-relaxed text-sm mt-3 preview-content"
			...
			{(() => {
				...
				return (
					<section className="p-8">
						{languages.length > 0 && (
							<div className="mb-4">
								<h3 className="text-2xl font-light mb-2" style={{ color: accentColor }}>Languages</h3>
						...
						{hobbies.length > 0 && (
							<div className="mb-4">
								<h3 className="text-2xl font-light mb-2" style={{ color: accentColor }}>Hobbies</h3>
								<ul className="list-disc list-inside text-gray-700">
						...
						{certifications.length > 0 && (
							<div className="mb-4">
								<h3 className="text-2xl font-light mb-2" style={{ color: accentColor }}>Certifications</h3>
								<ul className="list-disc list-inside text-gray-700">

              ...
              <h1 className="text-4xl font-bold leading-tight text-gray-900 sm:text-5xl sm:leading-tight lg:text-6xl lg:leading-tight font-pj">
                <span>
                  ...
                  <span className="text-rotate">
                    <span>
                      <span className="bg-green-400 text-green-950 px-2 rounded-2xl">
                        Growing
                      </span>
                      <span className="bg-yellow-400 text-yellow-950 px-2 rounded-2xl">
                        Achieving
                      </span>
                      <span className="bg-blue-400 text-blue-950 px-2 rounded-2xl">
                        Progressing
                      </span>
                      <span className="bg-red-400 text-red-950 px-2 rounded-2xl">
                        Winning Big
                      </span>
                      <span className="bg-black text-white px-2 rounded-2xl">
                        Your Success
                      </span>
                      <span className="bg-purple-400 text-purple-950 px-2 rounded-2xl">
                        Succeeding
                      </span>
                    </span>
                  </span>

...
const StructuredTemplate = ({ data, accentColor }) => {
        ...
        <div className="max-w-4xl mx-auto p-12 bg-white text-gray-800 leading-relaxed max-h-full font-serif">
            ...
            <header className="text-center mb-8 pb-4 border-b border-gray-300">
                ...
                <div className="text-xs text-gray-600">
                    ...
                    {data.personal_info?.location && (data.personal_info?.email || data.personal_info?.phone || data.personal_info?.linkedin || data.personal_info?.website) && (
                        <span className="mx-2">•</span>
                    )}
                    {data.personal_info?.email && (
                        <span>{data.personal_info.email}</span>
                    )}
                    {data.personal_info?.email && (data.personal_info?.phone || data.personal_info?.linkedin || data.personal_info?.website) && (
                        <span className="mx-2">•</span>
                    )}
                    {data.personal_info?.phone && (
                        <span>{data.personal_info.phone}</span>
                    )}
                    {data.personal_info?.phone && (data.personal_info?.linkedin || data.personal_info?.website) && (
                        <span className="mx-2">•</span>
                    )}

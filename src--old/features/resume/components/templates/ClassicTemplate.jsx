...
const ClassicTemplate = ({ data, accentColor }) => {
    ...
    return (
        <div className="max-w-4xl mx-auto p-8 bg-white text-gray-800 leading-relaxed max-h-full">
            {/* Header */}
            ...
            {(() => {
                ...
                return (
                    <section className="mb-6">
                        {languages.length > 0 && (
                            <div className="mb-3">
                                <h3 className="text-lg font-semibold" style={{ color: accentColor }}>Languages</h3>
                        ...
                        {hobbies.length > 0 && (
                            <div className="mb-3">
                                <h3 className="text-lg font-semibold" style={{ color: accentColor }}>Hobbies</h3>
                                <ul className="list-disc list-inside text-gray-700 mt-1">
                        ...
                        {certifications.length > 0 && (
                            <div className="mb-3">
                                <h3 className="text-lg font-semibold" style={{ color: accentColor }}>Certifications</h3>
                                <ul className="list-disc list-inside text-gray-700 mt-1">
